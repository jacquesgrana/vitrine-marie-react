        ...
        <article className="blog-post-container">
            ...
            <div className="d-flex justify-content-between gap-3">
                <p className="blog-post-date">
                    ...
                    {new Date(blogPost.createdAt.date.replace(' ', 'T')).toLocaleString('fr-FR', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric'
                    })}
                ...
                <p className="blog-post-date">
                    <span className="text-medium-white">Modifié le </span>
                    {new Date(blogPost.modifiedAt.date.replace(' ', 'T')).toLocaleString('fr-FR', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric'
                    })}
